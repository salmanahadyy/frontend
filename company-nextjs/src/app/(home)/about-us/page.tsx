...
export default function AboutUsPage() {
  return (
    <div className="pb-36">
      ...
      {/* Bagian ABOUT US */}
      <div className="font-bold bg-zinc-200 w-[90%] md:w-[700px] lg:w-[900px] mx-auto px-4 md:px-8 lg:px-12 pb-4 mt-2">
        <h1 className="p-4 sm:p-6 text-lg sm:text-xl text-center underline decoration-red-600">
          ABOUT US
        </h1>
      ...
      {/* Bagian Section */}
      <div className="font-bold text-center mt-8 text-lg sm:text-xl">
      ...
      >
        {/* OUR VALUE */}
        <div className="w-full md:w-[45%] lg:w-[400px] mx-auto bg-green-500 p-6 rounded-lg mb-6 md:mb-0">
          <Image
        ...
        {/* OUR STORY */}
        <div className="w-full md:w-[45%] lg:w-[400px] mx-auto bg-green-500 p-6 rounded-lg">
          <Image
