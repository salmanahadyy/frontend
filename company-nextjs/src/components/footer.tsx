                ...
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link href="https://shopee.co.id/yasalimhouse" target="_blank" className="hover:underline">
                                        Shopee
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://www.tokopedia.com/yasalimhouse" target="_blank" className="hover:underline">
                                        Tokopedia
                                    </Link>
                                </li>
                            </ul>
